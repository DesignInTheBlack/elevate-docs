...
## `row-spans` and `col-spans` Modifiers
...
| **Modifier**             | **Expected Values**              | **Example**                          |
|--------------------------|----------------------------------|--------------------------------------|
| From     | NumericToken (e.g., `2`, up to 12)         | `col-spans:from-2`                         |
| To          | NumericToken (e.g., `4`, up to 12)         | `row-spans:from-1:to-3`                         |

## Examples of Grid Layouts

Elevate CSS ensures creating grid layouts is intuitive and concise, enabling dynamic design with minimal effort.
