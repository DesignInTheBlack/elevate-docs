...
| h6  | Smallest heading size.                     | 1.125rem  | <p class = "font:heading6"> Aa </p> |
| h5  | Slightly larger heading for subsections.   | 1.5rem    | <p class = "font:heading5"> Aa </p> |
| h4  | Medium headings for section titles.        | 2.25rem   | <p class = "font:heading4"> Aa </p> |
| h3  | Large headings for standout content.       | 3.375rem  | <p class = "font:heading3"> Aa </p> |
| h2  | Extra-large headings for important areas.  | 5.062rem  | <p class = "font:heading2"> Aa </p> |
| h1  | Largest size for main titles.              | 7.594rem  | <p class = "font:heading1"> Aa </p> |
