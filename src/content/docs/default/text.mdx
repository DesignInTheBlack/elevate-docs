...
The font sizes are defined in `elevate/core/system/design/typography.ts` as part of the `size` property:
...
<p class="font:base text:indigo:loose">This is the body text styled with the base size.</p>
