...
### Env Aliases (Envelopes)

Condense a full utility string into a single reusable class with `env:name`, then reopen it later with `env:name:open` to edit. Env aliases are a first-class way to create meaningful, reusable classes without leaving your HTML.

<br/>

<LinkCard title="Learn Env Aliases" href="/guides/4-env-aliases/" />
